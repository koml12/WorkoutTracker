...
public class WorkoutViewDbHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_WORKOUT_TABLE = "CREATE TABLE " + WorkoutListContract.WorkoutListEntry.TABLE_NAME + " ("
    ...
    private final String CREATE_EXERCISE_TABLE = "CREATE TABLE " + WorkoutViewContract.WorkoutViewEntry.TABLE_NAME + " ("
    ...
    private final String DELETE_EXERCISE_TABLE = "DROP TABLE " + WorkoutViewContract.WorkoutViewEntry.TABLE_NAME;
    private final String DELETE_WORKOUT_TABLE = "DROP TABLE " + WorkoutListContract.WorkoutListEntry.TABLE_NAME;
    private final String DELETE_WEIGHT_TABLE = "DROP TABLE " + WeightContract.WeightEntry.TABLE_NAME;
